...
struct node sample_var_node ;
sample_var_node.var_name = "sample" ;
sample_var_node.next = NULL ;
%}
...
declList: INTEGERDECL varlist SEMI_COLON             
          { 
        ...
        | declList RET INTEGERDECL varlist SEMI_COLON    
            {
...
printStmt: PRINT_FN '(' print_var_expr_list ')' SEMI_COLON {$$ = $3 ;}


print_var_expr_list: expr                            {$$ = createFunc_Node(EXPR , sample_var_node , $1 , NULL);}
                   | print_var_expr_list ',' expr    
                    { struct funcStmt_node *s ;
                      s = createFunc_Node(EXPR , sample_var_node , $3 , NULL); 
